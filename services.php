...
<!-- Mirrored from html.favdevs.com/translo/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Mar 2025 09:00:12 GMT -->
    ...
    <div class="fix">
            ...
            <div id="sticky-header" class="menu-area">
                <div class="main-header-two__outer">
                    <div class="logo-box-two">
                        <a href="index.html"><img src="assets/img/resource/logo-6.png" alt="Logo"></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-three__single">
                            ...
                            <div class="services-three__single-content">
                                <div class="services-three__single-content-inner">
                                    <h2><a href="road-transport.html">Air Transport</a></h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing sed eiusmod</p>
                                    <div class="count-box">
                                        04
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-three__single">
                            ...
                            <div class="services-three__single-content">
                                <div class="services-three__single-content-inner">
                                    <h2><a href="road-transport.html">Rail Transport</a></h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing sed eiusmod</p>
                                    <div class="count-box">
                                        05
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-three__single">
                            ...
                            <div class="services-three__single-content">
                                <div class="services-three__single-content-inner">
                                    <h2><a href="road-transport.html">Warehousing</a></h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing sed eiusmod</p>
                                    <div class="count-box">
                                        06
                                    </div>
        ...
        <section class="work-process-two">
            <div class="work-process-two__bg"
                style="background-image: url(assets/img/background/work-process-v2-bg.jpg);"></div>
            <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".1s">
                                <div class="single-footer-widget footer-widget__about">
                                    <div class="logo-box">
                                        <a href="index.html"><img src="assets/img/resource/logo-5.png" alt=""></a>
                                    </div>
...
<!-- Mirrored from html.favdevs.com/translo/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Mar 2025 09:00:13 GMT -->
